namespace ControllerEmulatorAPI.vJoy
{
    ...
    public class VirtualJoystick : IDisposable
    {
        ...
        private static readonly VJoy vJoyInstance = new VJoy();
        ...
        /// </summary>
        public VJoy Joystick { get => vJoyInstance; }

        public VJoy.JoystickState GetJoystickState() => State;

        public void SetJoystickState(VJoy.JoystickState state) => State = state;
        ...
        public void SetJoystickAxis(int value, Axis usage, bool translate = true)
        {
            if (translate)
            {
                value *= -1;
        ...
        public void Reset()
        {
            SetJoystickAxis(0, Axis.HID_USAGE_RX);
            SetJoystickAxis(0, Axis.HID_USAGE_RY);
            SetJoystickAxis(0, Axis.HID_USAGE_Z);
            SetJoystickAxis(0, Axis.HID_USAGE_X);
            SetJoystickAxis(0, Axis.HID_USAGE_Y);
            SetJoystickHat(-1, Hats.Hat);
        }
    }
}